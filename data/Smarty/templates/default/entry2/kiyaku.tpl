    ...
    <div id="undercolumn_entry">
        ...
        <div class="btn_area">
            <ul>
                ...
                <li>
                    <a href="<!--{$smarty.const.TOP_URLPATH}-->entry2/" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_agree_on.jpg','b_agree');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_agree.jpg','b_agree');">
